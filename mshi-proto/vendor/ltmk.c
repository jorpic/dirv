/****************************************************************************/
/*      LTMK v4.06c for Linux. (c) ELCUS, 2002,2023.                        */
...
void tmkclrcwbits(TMK_DATA tmkClrControl)
{
  ...
  tmkError =
#endif
  ioctl(_ahVTMK4VxDusb[tmkCurNumber - tmkCnt], TMK_IOCtmkclrcwbits, tmkClrControl);
}
...
int tmkreadsn()
{
  ...
  return (ioctl(_ahVTMK4VxDusb[tmkCurNumber - tmkCnt], TMK_IOCtmkreadsn_usb));
}
