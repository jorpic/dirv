/****************************************************************************/
/*      LTMK.H v4.06c for Linux. (c) ELCUS, 2002,2023.                      */
/*      Interface to driver tmk1553b      v4.06 for Linux.                  */
/*      Interface to driver tmk1553busb   v1.09 for Linux.                  */
/****************************************************************************/
...
#define TMKUSB_VERSION_MIN 0x0109 /* v1.09 */
#define TMK_VERSION 0x0406     /* v4.06 */
#define TMKUSB_VERSION 0x0109 /* v1.09 */
#else
#define TMK_VERSION_MIN 0x0403 /* v4.03 */
#define TMKUSB_VERSION_MIN 0x0109 /* v1.09 */
#define TMK_VERSION 0x0406     /* v4.06 */
...
#define TMK_IOCtmkreadsn_usb _IO(TMK_IOC_MAGIC, VTMK_tmkreadsn_usb+TMK_IOC0)
